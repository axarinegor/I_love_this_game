...
from ..patterns.level_pattern import Lev_Patterns, digit_blocks_9
...
class Level_9:
    def __init__(self,
        ...
        self._ANSWER = [3, 2, 2, 4, 4, 1, 4, 1, 3, 2, 2, 0]
        ...
        self._digit_blocks = digit_blocks_9[:]
