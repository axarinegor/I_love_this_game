...
class Level_3:
    def __init__(self,
        ...
        self._platforms = [i for i in Lev_Patterns.get_default(3)]
    ...
    def on_draw(self) -> None:
        ...
        arcade.draw_texture_rect(self.block_texture, arcade.XYWH(BLOCK_HEIGHT // 2, PLAYER_SIZE.y + 10 + BLOCK_HEIGHT * 2.5, BLOCK_HEIGHT, BLOCK_HEIGHT))
        arcade.draw_texture_rect(self.block_texture, arcade.XYWH(BLOCK_HEIGHT // 2, PLAYER_SIZE.y + 10 + BLOCK_HEIGHT * 3.5, BLOCK_HEIGHT, BLOCK_HEIGHT))
        arcade.draw_texture_rect(self.block_texture, arcade.XYWH(BLOCK_HEIGHT // 2, PLAYER_SIZE.y + 10 + BLOCK_HEIGHT * 4.5, BLOCK_HEIGHT, BLOCK_HEIGHT))        
