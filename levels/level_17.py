...
class Level_17:
    ...
    def on_key_press(self, symbol: int, modifiers: int) -> None:
        ...
        if symbol == arcade.key.SPACE:
            self._player.toggle_gravity()
            self.is_normal_gravity = not self.is_normal_gravity
            return
    ...
    def on_draw(self) -> None:
        ...
        is_normal = 1 if self._player.gravity_direction == 1 else -1
        self._draw.player(self._player, -is_normal)
...
class Level_17:
    ...
    def on_key_press(self, symbol: int, modifiers: int) -> None:
        ...
        if symbol == arcade.key.SPACE:
            self._player.toggle_gravity()
            self._is_normal_gravity = not self._is_normal_gravity
            return
